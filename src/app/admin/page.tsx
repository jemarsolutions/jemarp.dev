  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-6 py-12">
      <header className="flex justify-between items-end mb-8">
        ...
        <Link 
          href="/admin/new" 
          className="flex items-center gap-2 bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 px-4 py-2 rounded-lg text-sm font-medium hover:opacity-90 transition-opacity"
        >
